...
#ifndef __BINDINGS_FRONTEND_H
#define __BINDINGS_FRONTEND_H
#ifdef __cplusplus
extern "C" {
#endif
...
typedef struct frontend_string_t {
  uint8_t*ptr;
  size_t len;
} frontend_string_t;

typedef struct frontend_tuple2_string_string_t {
  frontend_string_t f0;
  frontend_string_t f1;
} frontend_tuple2_string_string_t;

typedef struct frontend_list_tuple2_string_string_t {
  frontend_tuple2_string_string_t *ptr;
  size_t len;
} frontend_list_tuple2_string_string_t;

typedef struct frontend_list_string_t {
  frontend_string_t *ptr;
  size_t len;
} frontend_list_string_t;

typedef struct frontend_option_string_t {
  bool is_some;
  frontend_string_t val;
} frontend_option_string_t;
...
typedef struct frontend_list_u32_t {
  uint32_t *ptr;
  size_t len;
} frontend_list_u32_t;
...
typedef struct frontend_list_u8_t {
  uint8_t *ptr;
  size_t len;
} frontend_list_u8_t;
...
typedef struct frontend_tuple2_list_u8_bool_t {
  frontend_list_u8_t f0;
  bool f1;
} frontend_tuple2_list_u8_bool_t;

typedef struct wasi_filesystem_types_result_tuple2_list_u8_bool_error_code_t {
  bool is_err;
  union {
    frontend_tuple2_list_u8_bool_t ok;
    wasi_filesystem_types_error_code_t err;
  } val;
...
typedef struct frontend_tuple2_u64_u64_t {
  uint64_t f0;
  uint64_t f1;
} frontend_tuple2_u64_u64_t;
...
extern void wasi_cli_environment_get_environment(frontend_list_tuple2_string_string_t *ret);
// Get the POSIX-style arguments to the program.
extern void wasi_cli_environment_get_arguments(frontend_list_string_t *ret);
// Return a path that programs should use as their initial current working
// directory, interpreting `.` as shorthand for this.
extern void wasi_cli_environment_initial_cwd(frontend_option_string_t *ret);
...
// hazard.
extern void wasi_io_error_method_error_to_debug_string(wasi_io_error_borrow_error_t self, frontend_string_t *ret);
...
extern void wasi_io_poll_poll(wasi_io_poll_list_borrow_pollable_t *in, frontend_list_u32_t *ret);
...
extern void wasi_io_streams_method_output_stream_write(wasi_io_streams_borrow_output_stream_t self, frontend_list_u8_t *contents, wasi_io_streams_result_void_stream_error_t *ret);
...
// ```
extern void wasi_io_streams_method_output_stream_blocking_write_and_flush(wasi_io_streams_borrow_output_stream_t self, frontend_list_u8_t *contents, wasi_io_streams_result_void_stream_error_t *ret);
...
extern void wasi_filesystem_types_method_descriptor_write(wasi_filesystem_types_borrow_descriptor_t self, frontend_list_u8_t *buffer, wasi_filesystem_types_filesize_t offset, wasi_filesystem_types_result_filesize_error_code_t *ret);
...
extern void wasi_filesystem_types_method_descriptor_create_directory_at(wasi_filesystem_types_borrow_descriptor_t self, frontend_string_t *path, wasi_filesystem_types_result_void_error_code_t *ret);
...
extern void wasi_filesystem_types_method_descriptor_stat_at(wasi_filesystem_types_borrow_descriptor_t self, wasi_filesystem_types_path_flags_t path_flags, frontend_string_t *path, wasi_filesystem_types_result_descriptor_stat_error_code_t *ret);
...
extern void wasi_filesystem_types_method_descriptor_link_at(wasi_filesystem_types_borrow_descriptor_t self, wasi_filesystem_types_path_flags_t old_path_flags, frontend_string_t *old_path, wasi_filesystem_types_borrow_descriptor_t new_descriptor, frontend_string_t *new_path, wasi_filesystem_types_result_void_error_code_t *ret);
...
extern void wasi_filesystem_types_method_descriptor_open_at(wasi_filesystem_types_borrow_descriptor_t self, wasi_filesystem_types_path_flags_t path_flags, frontend_string_t *path, wasi_filesystem_types_open_flags_t open_flags, wasi_filesystem_types_descriptor_flags_t flags, wasi_filesystem_types_result_own_descriptor_error_code_t *ret);
...
extern void wasi_filesystem_types_method_descriptor_readlink_at(wasi_filesystem_types_borrow_descriptor_t self, frontend_string_t *path, wasi_filesystem_types_result_string_error_code_t *ret);
// Remove a directory.
// 
// Return `error-code::not-empty` if the directory is not empty.
// 
// Note: This is similar to `unlinkat(fd, path, AT_REMOVEDIR)` in POSIX.
extern void wasi_filesystem_types_method_descriptor_remove_directory_at(wasi_filesystem_types_borrow_descriptor_t self, frontend_string_t *path, wasi_filesystem_types_result_void_error_code_t *ret);
// Rename a filesystem object.
// 
// Note: This is similar to `renameat` in POSIX.
extern void wasi_filesystem_types_method_descriptor_rename_at(wasi_filesystem_types_borrow_descriptor_t self, frontend_string_t *old_path, wasi_filesystem_types_borrow_descriptor_t new_descriptor, frontend_string_t *new_path, wasi_filesystem_types_result_void_error_code_t *ret);
...
extern void wasi_filesystem_types_method_descriptor_symlink_at(wasi_filesystem_types_borrow_descriptor_t self, frontend_string_t *old_path, frontend_string_t *new_path, wasi_filesystem_types_result_void_error_code_t *ret);
// Unlink a filesystem object that is not a directory.
// 
// Return `error-code::is-directory` if the path refers to a directory.
// Note: This is similar to `unlinkat(fd, path, 0)` in POSIX.
extern void wasi_filesystem_types_method_descriptor_unlink_file_at(wasi_filesystem_types_borrow_descriptor_t self, frontend_string_t *path, wasi_filesystem_types_result_void_error_code_t *ret);
...
extern void wasi_filesystem_types_method_descriptor_metadata_hash_at(wasi_filesystem_types_borrow_descriptor_t self, wasi_filesystem_types_path_flags_t path_flags, frontend_string_t *path, wasi_filesystem_types_result_metadata_hash_value_error_code_t *ret);
...
extern void wasi_sockets_ip_name_lookup_resolve_addresses(wasi_sockets_ip_name_lookup_borrow_network_t network, frontend_string_t *name, wasi_sockets_ip_name_lookup_result_own_resolve_address_stream_error_code_t *ret);
...
// data.
extern void wasi_random_random_get_random_bytes(uint64_t len, frontend_list_u8_t *ret);
...
// a long period.
extern void wasi_random_insecure_get_insecure_random_bytes(uint64_t len, frontend_list_u8_t *ret);
...
// protection.
extern void wasi_random_insecure_seed_insecure_seed(frontend_tuple2_u64_u64_t *ret);

// Exported Functions from `bachelor:frontend/add@0.1.0`
uint32_t exports_bachelor_frontend_add_add(uint32_t a, uint32_t b);

// Exported Functions from `bachelor:frontend/client@0.1.0`
void exports_bachelor_frontend_client_get_sensor_data(frontend_string_t *ret);
