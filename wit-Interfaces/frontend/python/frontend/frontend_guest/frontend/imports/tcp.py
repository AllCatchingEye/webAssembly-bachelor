...
class TcpSocket:
    ...
    def start_bind(self, network: network.Network, local_address: network.IpSocketAddress) -> None:
        ...
        Raises: `frontend.types.Err(frontend.imports.network.ErrorCode)`
        """
    ...
    def keep_alive_enabled(self) -> int:
        """
    ...
    def set_keep_alive_enabled(self, value: int) -> None:
        """
        Raises: `frontend.types.Err(frontend.imports.network.ErrorCode)`
        """
        raise NotImplementedError
