...
class Exports:
    ...
    def init(self, caller: wasmtime.Store, app_name: str, symbols: Symbols, stub_wasi: bool) -> Result[None, str]:
        ptr, len0 = _encode_utf8(app_name, self.component._realloc1, self.component._core_memory0, caller)
        record = symbols
        field = record.types_package
        field1 = record.exports
        field2 = record.types
        ptr3, len4 = _encode_utf8(field, self.component._realloc1, self.component._core_memory0, caller)
        vec = field1
        len46 = len(vec)
        result = self.component._realloc1(caller, 0, 0, 4, len46 * 28)
        ...
        for i47 in range(0, len46):
            ...
            if isinstance(e, FunctionExportBundled):
                ...
                field9 = record6.name
                ptr10, len11 = _encode_utf8(field7, self.component._realloc1, self.component._core_memory0, caller)
                ...
                ptr12, len13 = _encode_utf8(field8, self.component._realloc1, self.component._core_memory0, caller)
                ...
                ptr14, len15 = _encode_utf8(field9, self.component._realloc1, self.component._core_memory0, caller)
                ...
                ptr20, len21 = _encode_utf8(field18, self.component._realloc1, self.component._core_memory0, caller)
                ...
                ptr22, len23 = _encode_utf8(field19, self.component._realloc1, self.component._core_memory0, caller)
                ...
                ptr28, len29 = _encode_utf8(field26, self.component._realloc1, self.component._core_memory0, caller)
                ...
                ptr30, len31 = _encode_utf8(field27, self.component._realloc1, self.component._core_memory0, caller)
                ...
                ptr33, len34 = _encode_utf8(payload32, self.component._realloc1, self.component._core_memory0, caller)
                ...
                ptr40, len41 = _encode_utf8(field37, self.component._realloc1, self.component._core_memory0, caller)
                ...
                ptr42, len43 = _encode_utf8(field38, self.component._realloc1, self.component._core_memory0, caller)
                ...
                ptr44, len45 = _encode_utf8(field39, self.component._realloc1, self.component._core_memory0, caller)
        ...
        vec101 = field2
        len103 = len(vec101)
        result102 = self.component._realloc1(caller, 0, 0, 4, len103 * 48)
        ...
        for i104 in range(0, len103):
            ...
            if isinstance(e48, TypeOwned):
                ...
                if isinstance(field52, OwnedKindRecord):
                    ...
                    vec60 = payload55
                    len62 = len(vec60)
                    result61 = self.component._realloc1(caller, 0, 0, 4, len62 * 8)
                    assert(isinstance(result61, int))
                    for i63 in range(0, len62):
                        e56 = vec60[i63]
                        base57 = result61 + i63 * 8
                        ptr58, len59 = _encode_utf8(e56, self.component._realloc1, self.component._core_memory0, caller)
                    ...
                    vec72 = payload64
                    len74 = len(vec72)
                    result73 = self.component._realloc1(caller, 0, 0, 4, len74 * 12)
                    ...
                    for i75 in range(0, len74):
                        ...
                        ptr70, len71 = _encode_utf8(field68, self.component._realloc1, self.component._core_memory0, caller)
                ...
                ptr92, len93 = _encode_utf8(field53, self.component._realloc1, self.component._core_memory0, caller)
                ...
                ptr94, len95 = _encode_utf8(field54, self.component._realloc1, self.component._core_memory0, caller)
