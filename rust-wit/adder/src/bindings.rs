    ...
    pub mod backend {
        pub mod adder {
            ...
            pub mod add {
                ...
                macro_rules! __export_backend_adder_add_0_1_0_cabi{
        ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

          #[export_name = "backend:adder/add@0.1.0#add"]
          unsafe extern "C" fn export_add(arg0: i32,arg1: i32,) -> i32 {
            $($path_to_types)*::_export_add_cabi::<$ty>(arg0, arg1)
                ...
                #[doc(hidden)]
                pub(crate) use __export_backend_adder_add_0_1_0_cabi;
            }
        }
    }
}
...
macro_rules! __export_adder_impl {
  ...
  $($path_to_types_root)*::exports::backend::adder::add::__export_backend_adder_add_0_1_0_cabi!($ty with_types_in $($path_to_types_root)*::exports::backend::adder::add);
  )
}
#[doc(inline)]
...
B\x02\x01@\x02\x01xz\x01yz\0z\x04\0\x03add\x01\0\x04\x01\x17backend:adder/add@0.\
1.0\x05\0\x04\x01\x19backend:adder/adder@0.1.0\x04\0\x0b\x0b\x01\0\x05adder\x03\0\
